...
def upload_dataset(args):
    ...
    if tt == 'hrnet':
        train_script = os.path.join(PROJECT_ROOT, "scripts", "aux", "training", "train_hrnet_keypoints.py")
        requirements = os.path.join(PROJECT_ROOT, "scripts", "aux", "training", "requirements_hrnet_runpod.txt")
    elif tt == 'unet':
        train_script = os.path.join(PROJECT_ROOT, "scripts", "aux", "training", "train_unet_lines.py")
